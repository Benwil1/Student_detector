const detector = require('../src/lib/detector');

/**
 * ADVERSARIAL CHALLENGE & WEIGHT OPTIMIZATION SUITE (CJS VERSION)
 */
...
function runChallenge() {
    ...
    const results = ADVERSARIAL_SAMPLES.map(sample => {
        const result = detector.calculateHumanScore(sample.text);
